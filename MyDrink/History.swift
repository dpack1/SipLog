...
class History: ObservableObject {
    @Published var servings: [Serving] //reloads body if new data is added
    let savePath =
        FileManager.documentsDirectory
        .appendingPathComponent("SavedDrinks")
    ...
    func save() {
        do {
            ...
            //atomicly means all in one go (for small data): completeFileProtection means the information is protected until the iphone is unlocked.
